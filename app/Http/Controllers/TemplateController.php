...
class TemplateController extends Controller
{
    ...
    public function preview(CertificateTemplate $template)
    {
        $sampleData = [
            ...
            'certificate_left_logo' => asset('images/sample-logo.png'),
            'certificate_right_logo' => asset('images/sample-logo.png'),
            'signature_left' => asset('images/sample-signature.png'),
            'signature_middle' => asset('images/sample-signature.png'),
            'signature_right' => asset('images/sample-signature.png'),
