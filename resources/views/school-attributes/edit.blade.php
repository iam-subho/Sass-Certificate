...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" x-data="attributeForm()">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Edit School Attribute</h1>
        <p class="mt-1 text-sm text-gray-500">Editing: {{ $attribute->name }}</p>
    </div>

    <div class="bg-white shadow sm:rounded-lg">
        <form action="{{ route('school-attributes.update', $attribute) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
