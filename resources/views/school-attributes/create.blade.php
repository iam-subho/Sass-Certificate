...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" x-data="attributeForm()">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-900">Create School Attribute</h1>
        <p class="mt-1 text-sm text-gray-500">This attribute will only be available to your school.</p>
    </div>

    <div class="bg-white shadow sm:rounded-lg">
        <form action="{{ route('school-attributes.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required
                        ...
                        placeholder="e.g., Behavior, Sports Performance">
                    @error('name')
            ...
            <div class="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                <a href="{{ route('school-attributes.index') }}" class="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                    Cancel
                </a>
