...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-600">Update class details</p>
    </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                              ...
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('description') border-red-500 @enderror">{{ old('description', $class->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="sections" id="sections" value="{{ old('sections', $class->sections) }}"
                ...
                @if($class->students_count > 0)
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <h4 class="text-sm font-medium text-blue-900 mb-2">Class Statistics</h4>
                        <dl class="space-y-1">
                            <div class="flex justify-between text-sm">
                                <dt class="text-blue-700">Total Students:</dt>
                                <dd class="font-semibold text-blue-900">{{ $class->students_count }}</dd>
                            </div>
                        </dl>
                    </div>
                @else
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-yellow-700">No students enrolled in this class yet.</p>
                            </div>
                        </div>
                    </div>
                @endif
