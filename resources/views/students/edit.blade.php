        ...
        <form action="{{ route('students.update', $student) }}" method="POST" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="date" name="dob" id="dob" value="{{ old('dob', $student->dob->format('Y-m-d')) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="mobile" id="mobile" value="{{ old('mobile', $student->mobile) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="mother_name" id="mother_name" value="{{ old('mother_name', $student->mother_name) }}" required
                ...
                <div>
                    ...
                    <select name="school_id" id="school_id" required
                        ...
                        {{ auth()->user()->isSchoolAdmin() ? 'disabled' : '' }}>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Trigger change event if class is already selected
